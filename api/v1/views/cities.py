...
@app_views.route('/counties/<county_id>/cities', methods=['GET'],
                 strict_slashes=False)
def get_cities(county_id):
    """
...
@app_views.route('/counties/<county_id>/cities', methods=['POST'],
                 strict_slashes=False)
def post_city(county_id):
    """
    Creates a City
    """
    county = storage.get(County, county_id)
